...
This document provides build instructions for building a development set using an ESP32-WROOM32 board that illustrates the use of the AirMeter.IO firmware with ESP32 MCUs.
