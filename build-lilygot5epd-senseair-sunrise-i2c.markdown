...
|Part|Description|
|--|--|
|SensorAssembly v1.0|The AirMeter.io Sensor Assembly PCB (See https://github.com/airmeter-io/SensorAssembly)|
...
|Part|Description|
|--|--|
|SensorAssembly v1.0|The AirMeter.io Sensor Assembly PCB (See [https://github.com/airmeter-io/SensorAssembly](https://github.com/airmeter-io/SensorAssembly))|
|2.54mm pin header|8 Way, 1 row, right angle pin header|
